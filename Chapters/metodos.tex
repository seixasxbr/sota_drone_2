...
A técnica de sliding mode control (SMC) é baseado do crtério de estabildiade de lyapunov. O SMC pode ser utilizado para aplicações em que o veóculo é submetido a trajetórias difícieis e pode lidar com grandes varições de parâmetros. O SMC pode lidar com incertezas paramétricas, erros de modelagem e pertubações.
